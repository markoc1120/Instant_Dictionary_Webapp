...
class Dictionary(page.Page):
    ...
    def serve(cls, req):
        ...
        output_div = jp.Div(a=div, classes='m-2 p-2 text-lg border-2 h-40 border-gray-300')
        input_box = jp.Input(a=input_div, outputdiv=output_div, placeholder='Type in a word here...',
                             classes='m-2 bg-gray-100 border-2 focus:bg-white border-gray-400 rounded w-64 '
